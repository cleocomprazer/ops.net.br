                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                                    CssClass="small pull-right text-danger" ValidationGroup="RegisterUserValidationGroup">* Obrigatório</asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ControlToValidate="ConfirmPassword" CssClass="small pull-right text-danger"
                                                    ...
                                                    ValidationGroup="RegisterUserValidationGroup">* Obrigatório</asp:RequiredFieldValidator>
