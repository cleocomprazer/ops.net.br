<%@ Page Title="OPS :: Lista de Secretários" Language="C#" MasterPageFile="~/PaginaInterna.Master" AutoEventWireup="true"
	CodeBehind="DetalhesSecretarios.aspx.cs" Inherits="AuditoriaParlamentar.DetalhesSecretarios" %>
	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				Secretários Parlamentares de <asp:Label ID="lblParlamentar" runat="server" Font-Bold="true"></asp:Label>
