...
namespace AuditoriaParlamentar.Classes
{
    ...
    {
        public const String TXT_SITUACAO_AGUARDANDO_REVISAO = "Aguardando Revisão";
        public const String TXT_SITUACAO_CASO_DUVIDOSO = "Caso Duvidoso";
        public const String TXT_SITUACAO_CASO_DOSSIE = "Caso Dossiê";
        public const String TXT_SITUACAO_CASO_REPETIDO = "Caso Repetido";
        public const String TXT_SITUACAO_NAO_PROCEDE = "Não Procede";
        public const String TXT_SITUACAO_PENDENTE_INFORMACOES = "Pendente Informação";

        public const String SITUACAO_AGUARDANDO_REVISAO = "A";
        public const String SITUACAO_CASO_DUVIDOSO = "P";
        public const String SITUACAO_CASO_DOSSIE = "D";
        public const String SITUACAO_CASO_REPETIDO = "R";
        public const String SITUACAO_NAO_PROCEDE = "N";
        public const String SITUACAO_PENDENTE_INFORMACOES = "I";

        public Int64 IdDenuncia { get; set; }
        public String Cnpj { get; set; }
        public String RazaoSocial { get; set; }
        public Int32 PendenteFoto { get; set; }
